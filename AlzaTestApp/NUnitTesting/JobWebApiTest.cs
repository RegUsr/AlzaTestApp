...
// </summary>
// ------------------------------------------------------------------------------------------------
namespace AlzaTestApp.NUnitTesting
{
    ...
    public class JobWebApiTest
    {
        ...
        /// <summary>
        /// Vstupní bod pro NUnit test runner. Pojato atomicky přes single Test.<br/>
        /// Lze pochopitelně dle potřeby přetvořit i do neatomické verze.<br/>
        /// Konfigurační NLog.config obsahuje cestu pro logFile.txt.<br/>
        /// Exekuce se aktivuje pomocí kombinace: Ctrl+R, A.<br/>
        /// </summary>
        [Test]
        public static void StartTests()
        {
            var resultMsg = MainPrgRunner()
                ? "PASS" : "FAILED";
            ...
            // Konec
            Assert.AreEqual("PASS", resultMsg);
